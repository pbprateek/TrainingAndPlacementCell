...
public class Student {
    ...
    public String getMarksbtech() {
        return marksbtech;
    }

    public void setMarksbtech(String marksbtech) {
    ...
    public String getYearbtech() {
        return yearbtech;
    }

    public void setYearbtech(String yearbtech) {
        this.yearbtech = yearbtech;
    }
}
